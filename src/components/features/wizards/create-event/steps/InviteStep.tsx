...
export function InviteStep({ form }: WizardStepProps<EventFormData>) {
	...
	return <InvitePeopleStep selectedUsers={invitees} onUserAdd={handleUserAdd} onUserRemove={handleUserRemove} />;
}
