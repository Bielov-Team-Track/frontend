		...
		<div className={className}>
						...
						return (
							...
							>
								...
								<button
									...
									className="p-1.5 rounded hover:bg-white/10 text-muted hover:text-error transition-colors"
			...
			{showAddForm ? (
					...
					<div className="flex gap-2">
						<div className="flex-1">
							<input
								...
								className="w-full px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white placeholder:text-muted/50 focus:outline-hidden focus:border-accent text-sm"
								autoFocus
							/>
						</div>
					</div>
				...
				<button
					...
					className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-dashed border-white/20 text-muted hover:border-white/40 hover:text-white hover:bg-white/5 transition-all"
				>
					<Link2 size={16} />
