	...
	return (
		<div className="space-y-4">
			...
			<div className="space-y-3">
				...
				<div
					className="flex justify-between items-center space-x-3 p-4 rounded-lg border border-base-300 bg-background-light"
					onClick={(e) => {
						e.stopPropagation();
					}}
				>
				...
				<div
					className={`flex items-center space-x-3 p-4 rounded-lg border ${
						isCardAvailable
							? "border-base-300 bg-background-light"
							: "border-base-300 bg-background-light"
					}`}
				>
					<div className="flex-1">
						<div className="flex items-center space-x-2">
							<FaCreditCard
								className={isCardAvailable ? "text-primary" : "/40"}
							/>
						...
						<p className="text-sm /60 mt-1">Accept card payments via Stripe</p>
					</div>
					{isCardAvailable ? (
						<Controller
							name="budget.paymentMethods"
