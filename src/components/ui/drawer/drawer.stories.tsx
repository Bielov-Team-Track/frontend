...
const meta: Meta<typeof Drawer> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A drawer/sidebar navigation component with toggle functionality. Contains header and navigation links.',
      },
    },
    nextjs: {
      appDirectory: true,
  ...
  args: {
    children: (
      <main className="p-8">
        ...
        <p className="mb-4">
          This is the main content area. Click the hamburger menu in the header to open the drawer.
        </p>
      ...
      <main className="p-8">
        ...
        <div className="grid gap-4">
          <div className="bg-base-100 p-6 rounded-lg shadow border-l-4 border-primary">
            ...
            <p className="text-base-content/70 mb-2">Beach volleyball tournament at Santa Monica</p>
            <div className="flex justify-between items-center">
          ...
          <div className="bg-base-100 p-6 rounded-lg shadow border-l-4 border-secondary">
            ...
            <p className="text-base-content/70 mb-2">Weekly training at Indoor Sports Center</p>
            <div className="flex justify-between items-center">
