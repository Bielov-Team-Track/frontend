        ...
        <div className="modal-box">
          ...
          <div className="modal-action">
            <div className='w-full flex justify-around'>
              <button className="btn btn-success w-16 text-neutral-50">{args.confirmText || 'Yes'}</button>
              <button className="btn btn-error w-16 text-neutral-50">{args.declineText || 'No'}</button>
            </div>
          </div>
        </div>
      </div>
