...
const meta: Meta<typeof BlockOverlay> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A blocking overlay component that displays a lock icon and reason for blocking, typically used to prevent user interaction.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  decorators: [
    (Story) => (
      <div style={{ position: 'relative', width: '400px', height: '300px', border: '1px solid #ccc' }}>
        <div style={{ padding: '20px', backgroundColor: '#f9f9f9', height: '100%' }}>
  ...
  args: {
    reason: (
      <div className="text-center">
        ...
        <p className="text-gray-200">This feature requires a premium subscription</p>
      </div>
    ),
  },
}
...
export const InFormContext: Story = {
  render: () => (
    <div style={{ position: 'relative', width: '400px', height: '350px', border: '1px solid #ccc' }}>
      <div style={{ padding: '20px', backgroundColor: '#ffffff', height: '100%' }}>
      ...
      <BlockOverlay 
        reason="Registration is temporarily disabled"
      />
    </div>
  ),
  parameters: {
