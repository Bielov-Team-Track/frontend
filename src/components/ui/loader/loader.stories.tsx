...
const meta: Meta<typeof Loader> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A loading spinner component that centers itself and displays a large spinning animation.',
      },
    },
  },
  tags: ['autodocs'],
...
export const FullScreenOverlay: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Loader used as a full-screen overlay with a modal-like container.',
      },
    },
  },
}
