...
const meta: Meta<typeof ImageCropper> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"An image cropping component using react-easy-crop. Features a dark theme UI, zoom slider, and responsive layout.",
			},
		},
	},
	tags: ["autodocs"],
	argTypes: {
		...
		onImageSave: {
			description:
				"Callback function called when the cropped image is saved. Receives a Blob.",
		},
        onCancel: {
