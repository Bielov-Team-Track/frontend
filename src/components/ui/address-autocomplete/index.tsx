	...
	return (
		<div className="form-control w-full relative isolate">
			...
			{isOpen && suggestions.length > 0 && (
				<div
					className="absolute top-full left-0 right-0 mt-1 bg-[141414] border border-base-300 rounded-lg shadow-lg max-h-60 overflow-auto"
					style={{ zIndex: 999999 }}
				>
								...
								<div className="flex-1 min-w-0">
									{suggestion.structured_formatting ? (
										<div>
											...
											<div className="text-sm /70 truncate">
