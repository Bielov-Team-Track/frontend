  ...
  return (
    <div className="max-w-lg flex-1">
      ...
      <div className=" flex flex-col w-full gap-2">
        {event.budget && (
          <div className="flex items-center justify-between py-4 px-6 rounded-lg bg-stone-900/50">
        ...
        {userProfile && userPayment && (
          <div className="flex flex-col gap-2 p-4 rounded-lg bg-stone-900/50">
        ...
        {captainsTeams &&
          captainsTeams.map(async (t, index) => {
            ...
            return (
              <div
                key={t.id}
                className="flex flex-col gap-2 p-4 rounded-lg bg-stone-900/50"
              >
                <div className="flex items-center justify-between">
                  <div className="flex flex-col gap-1">
                    <span className="font-medium">Team Payment</span>
                    <span className="text-sm text-neutral/60">{t.name}</span>
                  </div>
                ...
                <div key={t.id} className="mt-2">
                  <div className="text-sm text-neutral/60 font-medium">
                    Team members
                  </div>
                  <div className="flex flex-col gap-2 mt-1">
                    {payments.map((p) => {
                      ...
                      return (
                        <div
                          key={p.id}
                          className="flex items-center justify-between rounded-md bg-stone-900/90 p-2 pr-4"
                        >
