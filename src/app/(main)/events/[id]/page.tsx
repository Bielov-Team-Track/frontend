			...
			<div className="flex flex-col p-4 gap-4">
				...
				{event.admins && event.admins.length > 0 && (
					<div className="flex flex-col gap-4 items-start">
						...
						<div className="duration-200 ease-in-out overflow-hidden transition-transform cursor-pointer hover:scale-[1.02] active:scale-100 transform-gpu p-4 rounded-lg bg-background flex items-start justify-start gap-4 flex-wrap">
