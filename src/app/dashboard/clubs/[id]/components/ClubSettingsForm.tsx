		...
		<form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl space-y-6">
			...
			<div className="rounded-2xl bg-white/5 border border-white/10 overflow-hidden">
				...
				<div className="px-6 pb-6">
					...
					<p className="text-xs text-muted mt-2">Click on logo or banner to change. Changes save when you submit the form.</p>
				</div>
			</div>
			...
			<div className="rounded-2xl bg-white/5 border border-white/10 p-6 space-y-4">
				...
				<div>
					<label className="block text-sm font-medium text-muted mb-2">Club Name *</label>
					<input
						type="text"
				...
				<div className="grid grid-cols-2 gap-4">
					...
					<div>
						<label className="block text-sm font-medium text-muted mb-2">Contact Phone</label>
						<input
							type="tel"
			...
			<div className="flex justify-end gap-3">
				<button
					...
					{updateMutation.isPending ? <span className="loading loading-spinner loading-sm" /> : <Save size={16} />}
					Save Changes
				</button>
			</div>
