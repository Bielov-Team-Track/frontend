	...
	const navItems: SettingsNavItem[] = [
		{
			...
			label: "General",
			icon: Settings,
			href: `/hub/events/${eventId}/settings/general`,
		},
		{
			id: "datetime",
			label: "Date & Time",
			icon: Calendar,
			href: `/hub/events/${eventId}/settings/datetime`,
		},
		{
			id: "location",
			label: "Location",
			icon: MapPin,
			href: `/hub/events/${eventId}/settings/location`,
		},
		{
			id: "registration",
			label: "Registration",
			icon: Users,
			href: `/hub/events/${eventId}/settings/registration`,
		},
		{
			id: "payments",
			label: "Payments",
			icon: CreditCard,
			href: `/hub/events/${eventId}/settings/payments`,
		},
		{
			id: "danger",
			label: "Danger Zone",
			icon: AlertTriangle,
			href: `/hub/events/${eventId}/settings/danger`,
			danger: true,
		},
	];
