...
export const metadata: Metadata = {
	title: "Privacy Policy | Spike",
	description: "Privacy policy for Spike volleyball community application",
};
			...
			<div className="container mx-auto sm:px-4 sm:py-8">
				<div className="max-w-4xl mx-auto bg-base-100 rounded-lg shadow-xl sm:p-8 p-4">
					...
					<div className="text-center mb-8">
						...
						<p className="/70">Last updated: September 19, 2025</p>
					</div>
					...
					<div className="prose prose-lg max-w-none space-y-6">
						...
						<div className="bg-base-200 sm:p-6 rounded-lg">
							...
							<ul className="list-disc pl-6 mt-4 space-y-2">
								...
								<li>Download and use our mobile application (Spike), or any other application of ours that links to this Privacy Notice</li>
						...
						<section>
							...
							<p className="mb-4">
								This summary provides key points from our Privacy Notice, but you can find out more details about any of these topics by using
						...
						<section id="section1" className="scroll-mt-8">
							...
							<h3 className="text-xl font-medium  mb-3">Personal Information You Disclose to Us</h3>
							<p className="mb-4">
							...
							<div className="bg-base-200 p-4 rounded-lg mb-4">
								...
								<div className="grid gap-2 md:grid-cols-2">
									...
									<span className="badge badge-outline">Contact preferences</span>
									<span className="badge badge-outline">Billing addresses</span>
									<span className="badge badge-outline">Debit/credit card numbers</span>
									<span className="badge badge-outline">Contact or authentication data</span>
								</div>
							</div>
							...
							<div className="alert alert-info mb-4">
								...
								<div>
									...
									<p className="text-sm">
										We may collect data necessary to process your payment if you choose to make purchases. All payment data is handled and
										stored by{" "}
										<a href="https://stripe.com/gb/privacy" className="link" target="_blank" rel="noopener noreferrer">
											Stripe
										</a>
										.
									</p>
							...
							<ul className="list-disc pl-6 space-y-2">
								<li>
									<strong>Geolocation Information:</strong> We may request access to track location-based information from your mobile device
									to provide location-based services.
								</li>
								<li>
									<strong>Mobile Device Access:</strong> We may request access to certain features from your mobile device, including
									calendar, reminders, social media accounts, and other features.
								</li>
								<li>
									<strong>Push Notifications:</strong> We may request to send you push notifications regarding your account or certain
									features of the application(s).
								</li>
							</ul>

							<h4 className="font-semibold mb-2 mt-6">Information Automatically Collected</h4>
							<p className="mb-4">
							...
							<p className="mb-4">
								...
								characteristics, operating system, language preferences, referring URLs, device name, country, location, and other technical
								information.
							</p>
						</section>
						...
						<section id="section2" className="scroll-mt-8">
							...
							<div className="card bg-base-200 p-4">
								...
								<ul className="list-disc pl-6 space-y-2">
									...
									<li>To provide, improve, and administer our volleyball community services</li>
									<li>To facilitate event creation, management, and participation</li>
									<li>To process payments for events and tournaments</li>
									<li>To connect you with other volleyball players and events</li>
									<li>To send notifications about events, matches, and community updates</li>
						...
						<section id="section3" className="scroll-mt-8">
							...
							<p className="mb-4">
								...
								reason to do so under applicable law.
							</p>
							...
							<div className="space-y-4">
								...
								<div className="card bg-base-200 p-4">
									...
									<p className="text-sm">
										...
										of a third party, such as situations involving potential threats to safety.
									</p>
								</div>
							</div>
						</section>
						...
						<section id="section4" className="scroll-mt-8">
							...
							<div className="alert alert-warning mb-4">
								...
								<div>
									...
									<p className="text-sm">
										Your profile information is visible to other players in volleyball events you join. Contact details may be shared with
										event organizers for coordination purposes.
									</p>
								</div>
							</div>
							...
							<ul className="list-disc pl-6 space-y-2">
								<li>
									<strong>Business Transfers:</strong> We may share or transfer your information in connection with any merger, sale of
									company assets, financing, or acquisition of all or a portion of our business to another company.
								</li>
								<li>
									<strong>Google Maps Platform APIs:</strong> We may share your information with certain Google Maps Platform APIs (e.g.
									Google Maps API, Places API) to provide location-based services.
								</li>
								<li>
									<strong>Payment Processors:</strong> Payment information is processed securely through Stripe according to their privacy
									policy.
								</li>
							</ul>
						</section>
						...
						<section id="section5" className="scroll-mt-8">
							<h2 className="text-2xl font-semibold  mb-4">5. Do We Use Cookies and Other Tracking Technologies?</h2>
							<p className="mb-4">
								<strong>In Short:</strong> We may use cookies and other tracking technologies to collect and store your information.
							</p>
							<p className="mb-4">
								We may use cookies and similar tracking technologies to gather information when you interact with our Services. Some online
								tracking technologies help us maintain the security of our Services and your account, prevent crashes, fix bugs, save your
						...
						<section id="section7" className="scroll-mt-8">
							...
							<p className="mb-4">
								<strong>In Short:</strong> We keep your information for as long as necessary to fulfil the purposes outlined in this Privacy
							...
							<p className="mb-4">
								...
								your personal information, we will either delete or anonymise such information.
							</p>
							<ul className="list-disc pl-6 space-y-2">
						...
						<section id="section8" className="scroll-mt-8">
							...
							<p className="mb-4">
								<strong>In Short:</strong> We aim to protect your personal information through a system of organisational and technical security
								measures.
							</p>
							...
							<div className="grid gap-4 md:grid-cols-2">
								...
								<div className="card bg-warning/20 p-4">
									...
									<p className="text-sm">
										No electronic transmission over the Internet can be guaranteed to be 100% secure. You should only access our Services
						...
						<section id="section10" className="scroll-mt-8">
							...
							<p className="mb-4">
								<strong>In Short:</strong> In some regions, you have rights that allow you greater access to and control over your personal
								information.
							</p>
							...
							<div className="bg-base-200 p-6 rounded-lg">
								...
								<div className="mt-4 p-3 bg-info/20 rounded">
									<p className="text-sm">
										<strong>Account Management:</strong> You can log in to your account settings and update your user account. Upon your
										request to terminate your account, we will deactivate or delete your account and information from our active databases.
									</p>
								</div>
							</div>
						</section>
						...
						<section id="section11" className="scroll-mt-8">
							...
							<p className="mb-4">
								Most web browsers and some mobile operating systems include a Do-Not-Track (&lsquo;DNT&rsquo;) feature or setting. At this
								stage, no uniform technology standard for recognising and implementing DNT signals has been finalised. As such, we do not
						...
						<section id="section12" className="scroll-mt-8">
							...
							<p className="mb-4">
								We may update this Privacy Notice from time to time. The updated version will be indicated by an updated &lsquo;Revised&rsquo;
						...
						<section id="section14" className="scroll-mt-8">
							...
							<div className="card bg-base-200 p-4">
								...
								<p>
									To request to review, update, or delete your personal information, please contact us using the information provided above or
						...
						<div className="alert alert-info mt-8">
							...
							<div>
								...
								<div className="text-sm">
									This privacy policy is tailored for the Spike volleyball community application. Please review it carefully and consult legal
									counsel for any specific compliance requirements. We are committed to protecting your privacy and ensuring compliance with
